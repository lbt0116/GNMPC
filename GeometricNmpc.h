...
private:
    ...
    Eigen::Matrix<double, 4, 4> getErrorM(const Eigen::Matrix<double, 4, 4> &M, const Eigen::Matrix<double, 4, 4> &M_d);
    Eigen::Matrix<double, 6, 1> getErrorTwist(const Eigen::Matrix<double, 6, 1> &Twist,
    ...
    void discreteAB(const Eigen::Matrix<double, Kdim, Kdim> &A, const Eigen::Matrix<double, Kdim, Eigen::Dynamic> &B);
    ...
    void buildTimeVaryingQP(const std::vector<Eigen::Matrix<double, Kdim, Kdim>> &A_list,
                            const std::vector<Eigen::Matrix<double, Kdim, Eigen::Dynamic>> &B_list,
                            const Eigen::Matrix<int, 4, 1> &Leg_Contact_State);
    void predictStateTrajectory(const Eigen::Matrix<double, Eigen::Dynamic, 1> &f);
